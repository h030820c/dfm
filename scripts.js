...
if(newsContainer){
    fetch("https://newsapi.org/v1/articles?source=bbc-news&apiKey=8c1a629cd12a4670895eea1aa75c9426")
        .then(response => {
            return response.json();
        }).then(news => {
...
if(askJack){
    const askJackFormSubmit = e => {
        ...
        fetch("https://h030820c.github.io/dfm/first.html", {mode: "no-cors", method: "POST", body: contact})
            .then(response => {
